        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeBetweenAttemptsMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AwardedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizTagMappings", x => new { x.QuizzesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_QuizTagMappings_QuizTags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "QuizTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizTagMappings_Quizzes_QuizzesId",
                        column: x => x.QuizzesId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningObjective = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionResponses_QuizAttemptId_QuestionId",
                table: "QuestionResponses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizTagMappings_TagsId",
                table: "QuizTagMappings",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizTags_Name",
                table: "QuizTags",
                column: "Name",
                unique: true);
