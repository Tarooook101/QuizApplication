...
public class DeactivateQuizCommandHandler : BaseHandler, ICommandHandler<DeactivateQuizCommand>
{
    private readonly IQuizRepository _quizRepository;
    private readonly ICurrentUserService _currentUserService;

    public DeactivateQuizCommandHandler(
    ...
    public async Task<Result> Handle(DeactivateQuizCommand request, CancellationToken cancellationToken)
    {
        ...
        quiz.Deactivate(_currentUserService.UserName);
